...
VALUES ('9789634472384','Dermesztő Nyár','Alexandra Könyvesház Kft.','2018','Krimi','672','4499',strftime('%s', '2019-02-12'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789634194347','Terror','Agave Könyvek Kiadó Kft.','2018','Thriller','714','5980',strftime('%s', '2019-02-15'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789631365801','Nagyváros lélek nélkül. Bécs 1938','Corvinia Kiadó Kft.','2019','Történelem','431','4990',strftime('%s', '2019-04-05'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789639183377','Ecce Homo','Göncöl Kiadó Kft.','2003','Filozófia','146','1895',strftime('%s', '2019-04-05'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789634793335','Elmélkedések','Helikon Kiadó Kft.','2019','Filozófia','165','1299',strftime('%s', '2019-04-07'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789634792987','Az örök béke','Helikon Kiadó Kft.','2019','Filozófia','84','1499',strftime('%s', '2019-04-20'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789632276359','Gépnarancs','Helikon Kiadó Kft.','2016','Regény','220','2999',strftime('%s', '2019-04-20'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789634790853','Az úr hangja','Helikon Kiadó Kft.','2018','Regény','288','2999',strftime('%s', '2019-04-20'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789634194040','Expedíció','Agave Könyvek Kiadó Kft.','2018','Sci-fi','172','2980',strftime('%s', '2019-11-02'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789634700074','Az idő gyermekei','Fumax Kft.','2017','Sci-fi','612','4995',strftime('%s', '2019-11-02'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789630984751','A gömb','Kossuth Kiadó Zrt.','2016','Sci-fi','413','3600',strftime('%s', '2019-08-25'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789634470878','Trónok harca','Alexandra Kiadó','2018','Fantasy','925','4999',strftime('%s', '2018-02-10'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9786155514333','A marsi','Fumax Kft.','2015','Sci-fi','357','4495',strftime('%s', '2018-03-18'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789633552605','A Harmadik Birodalom születése','Park Könyvkiadó Kft.','2015','Történelem','600','7500',strftime('%s', '2020-01-06'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789634192541','Borne','Agave Könyvek Kiadó Kft.','2017','Sci-fi','315','3580',strftime('%s', '2020-02-28'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789634700456','Hadállat','Fumax Kft.','2018','Sci-fi','340','3995',strftime('%s', '2020-02-28'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789634067962','NOS4A2','Gabo Könyvkiado Kft.','2019','Thriller','756','4990',strftime('%s', '2020-03-24'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789634333678','A teljes Maus','Libri Könyvkiadó Kft.','2019','Képregény','296','3799',strftime('%s', '2020-03-24'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789632521213','Az idő rövid története','Akkord Kiadó Kft.','2019','Csillagászat','256','5690',strftime('%s', '2020-03-25'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789634194071','Kontroll','Agave Könyvek Kiadó Kft.','2018','Sci-fi','321','3280',strftime('%s', '2020-04-06'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789631422511','A nyugalom','Magvető Kft.','2018','Regény','326','3499',strftime('%s', '2020-04-06'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789631425796','A séta','Magvető Kft.','2017','Regény','154','2490',strftime('%s', '2020-05-17'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789630982771','Jurassic Park','Kossuth Kiadó Zrt.','2015','Thriller','496','3600',strftime('%s', '2018-09-21'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789639998629','A pokolból','Vad Virágok Kiadó Kft.','2019','Képregény','574','7590',strftime('%s', '2018-09-22'));
INSERT INTO konyv (isbn, cim, kiado, kiadasi_ev, kategoria, oldalak_szama, ar, felvetel_datuma) 
VALUES ('9789632274690','Bálványok alkonya','Helikon Kiadó Kft.','2019','Filozófia','128','999',strftime('%s', '2020-05-15'));
...
VALUES ('4','Futár Zoltán','+36304514487','zolifutar@gmail.com','Győr, Szivárvány utca 33',strftime('%s', '2020-01-03'),'New');
INSERT INTO rendeles (rendelesszam, megrendelo, telefonszam, email, szallitasi_cim, rendeles_datuma, allapot) 
VALUES ('3','Hűvös Kornél','06704859748','huvos@citromal.com','Budapest, Sáros utca 13',strftime('%s', '2020-01-03'),'New');
INSERT INTO rendeles (rendelesszam, megrendelo, telefonszam, email, szallitasi_cim, rendeles_datuma, allapot) 
VALUES ('2','Pocsai Zsolt','06304444555','the_author@gmail.com','Szeged, Damjanich utca 22',strftime('%s', '2020-02-16'),'Processed');
INSERT INTO rendeles (rendelesszam, megrendelo, telefonszam, email, szallitasi_cim, rendeles_datuma, allapot) 
VALUES ('5','Peter Griffin','+36704571121','iamcrazy@gmail.com','Quaghao',strftime('%s', '2020-02-16'),'New');
INSERT INTO rendeles (rendelesszam, megrendelo, telefonszam, email, szallitasi_cim, rendeles_datuma, allapot) 
VALUES ('6','Peter Falk','+36309695532','colombo@gmail.com','California',strftime('%s', '2020-02-18'),'New');
INSERT INTO rendeles (rendelesszam, megrendelo, telefonszam, email, szallitasi_cim, rendeles_datuma, allapot) 
VALUES ('7','Simple Joe','+36304018845','simple@gmail.com','Budapest, Magyaros utca 3',strftime('%s', '2020-03-18'),'New');
INSERT INTO rendeles (rendelesszam, megrendelo, telefonszam, email, szallitasi_cim, rendeles_datuma, allapot) 
VALUES ('8','Dombi Ferenc','+36307084595','dombos@citromail.com','Pécs, Árkos körút 32',strftime('%s', '2020-03-18'),'New');
INSERT INTO rendeles (rendelesszam, megrendelo, telefonszam, email, szallitasi_cim, rendeles_datuma, allapot) 
VALUES ('9','Kardos Ágnes','+36305023069','gameofthrones@gmail.com','Szeged, Szivárvány utca 12',strftime('%s', '2020-03-19'),'New');
